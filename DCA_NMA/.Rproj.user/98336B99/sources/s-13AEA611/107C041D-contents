...
plot(x=nb$threshold[19:40], y=nb$Natalizumab[19:40], type="l",lwd=4,col="seagreen3",xlim=c(0.19, 0.40), ylim=c(ymin, ymax+0.2), xlab="Threshold probability", ylab=paste("Net Benefit"))
# adding treat none option
lines(x=nb$threshold[19:40], y=nb$Placebo[19:40],col="steelblue3",lwd=4)
lines(nb$threshold[19:40],y=nb$`Dimethyl FUmerate`[19:40],col="lightgoldenrod2",lwd=4)
lines(nb$threshold[19:40],y=nb$`Glatiramer Acetate`[19:40],col="orange",lwd=4)
lines(nb$threshold[19:40],y=nb$Model[19:40],lwd=4, col="red")
...
lines(nb$threshold[19:20], y=nb$OptimalNB[19:20]+0.007, type="l",lty = "dashed",col="black",lwd=4)
lines(nb$threshold[20:21], y=nb$OptimalNB[20:21]+0.007, type="l",lty = "dashed",col="black",lwd=4)
lines(nb$threshold[21:22], y=nb$OptimalNB[21:22]+0.007, type="l",lty = "dashed",col="black",lwd=4)
lines(nb$threshold[22:24], y=nb$OptimalNB[22:24]+0.007, type="l",lty = "dashed",col="black",lwd=4)
lines(nb$threshold[24:25], y=nb$OptimalNB[24:25]+0.007, type="l",lty = "dashed",col="black",lwd=4)
lines(nb$threshold[25:40], y=nb$OptimalNB[25:40]+0.007, type="l",lty = "dashed",col="black",lwd=4)
