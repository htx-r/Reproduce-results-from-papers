...
SMSC_placebo$relapse.2y.after.study[which(SMSC_placebo$relapse.2y.after.study=="No")]<-0
SMSC_placebo$relapse.2y.after.study[which(SMSC_placebo$relapse.2y.after.study=="Yes")]<-1

#outcomeP=PlaceboArms$Relapse2year,
#NpPlacebo=nrow(PlaceboArms),

jagsdataIPDNMA_Relapse <- list(
  Nstudies=3,
  Np=nrow(data_CDP_CC),
  ...
  outcomeP=PlaceboArms$Relapse2year,
  NpPlacebo=nrow(PlaceboArms),
  outcomeP2=SMSC_placebo$relapse.2y.after.study,
  NpPlacebo2=nrow(SMSC_placebo),
