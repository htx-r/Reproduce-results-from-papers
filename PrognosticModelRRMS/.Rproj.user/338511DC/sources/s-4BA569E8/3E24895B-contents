...
Validation21<-BootstrapValidationPrModel2.fun(imp.list[[1]],10,jagsoutput=SMSCjagsResults1$BUGSoutput$summary)
val21<-cbind(Validation21[[4]], Validation21[[5]])
Validation22<-BootstrapValidationPrModel2.fun(imp.list[[2]],10, jagsoutput=SMSCjagsResults2$BUGSoutput$summary)
val22<-cbind(Validation22[[4]], Validation22[[5]])
Validation23<-BootstrapValidationPrModel2.fun(imp.list[[3]],10, jagsoutput=SMSCjagsResults3$BUGSoutput$summary)
val23<-cbind(Validation23[[4]], Validation23[[5]])
Validation24<-BootstrapValidationPrModel2.fun(imp.list[[4]],10, jagsoutput=SMSCjagsResults4$BUGSoutput$summary)
val24<-cbind(Validation24[[4]], Validation24[[5]])
Validation25<-BootstrapValidationPrModel2.fun(imp.list[[5]],10, jagsoutput=SMSCjagsResults5$BUGSoutput$summary)
val25<-cbind(Validation25[[4]], Validation25[[5]])
Validation26<-BootstrapValidationPrModel2.fun(imp.list[[6]],10, jagsoutput=SMSCjagsResults6$BUGSoutput$summary)
val26<-cbind(Validation26[[4]], Validation26[[5]])
Validation27<-BootstrapValidationPrModel2.fun(imp.list[[7]],10, jagsoutput=SMSCjagsResults7$BUGSoutput$summary)
val27<-cbind(Validation27[[4]], Validation27[[5]])
Validation28<-BootstrapValidationPrModel2.fun(imp.list[[8]],10, jagsoutput=SMSCjagsResults8$BUGSoutput$summary)
val28<-cbind(Validation28[[4]], Validation28[[5]])
Validation29<-BootstrapValidationPrModel2.fun(imp.list[[9]],10, jagsoutput=SMSCjagsResults9$BUGSoutput$summary)
val29<-cbind(Validation29[[4]], Validation29[[5]])
Validation210<-BootstrapValidationPrModel2.fun(imp.list[[10]],10, jagsoutput=SMSCjagsResults10$BUGSoutput$summary)
